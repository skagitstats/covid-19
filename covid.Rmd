...
`r newthought('Total daily counts')` of covid-19 cases, hospitalizations and deaths reported by [Skagit Public Health](https://www.skagitcounty.net/Departments/HealthDiseases/coronavirus.htm){target="_blank"}. 
...
### Other 
 ...
 - Observable reports where the charts above are generated  
    1. [Skagit Valley Counts](https://observablehq.com/@marshallbrown/covid-19-in-washington-state1){target="_blank"}
